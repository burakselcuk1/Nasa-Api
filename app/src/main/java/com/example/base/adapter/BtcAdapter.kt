...
class BtcAdapter(private val dataSet: Nasa) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.btc_item, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        val dataString = dataSet.data[position]
        viewHolder.textView.text = dataString.toString()

        Log.d("burak", dataString.toString())
